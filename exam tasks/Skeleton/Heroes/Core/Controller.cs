...
namespace Heroes.Core
{
    ...
    internal class Controller : IController
    {
        ...
        {
            if (heroes.Models.Any(n => n.Name == name))            
        ...
        {
            if (weapons.Models.Any(n => n.Name == name))            
        ...
        {
            Map map = new Map();
            ICollection<IHero> fight = heroes.Models.Where(p => p.IsAlive && p.Weapon != null).ToList();
            return map.Fight(fight);
        }
    }
}
